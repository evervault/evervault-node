...
=======
  ...
  /** @type {import('./config').SupportedCurve} */ curve;
  /** @type {ReturnType<import('./core/http')>} */ http;
  /** @type {import('./utils/httpsHelper')} */ httpsHelper;
  /** @type {boolean | undefined} */ retry;

  /**
   * @typedef OutboundRelayOptions
   * @property {string[] | undefined} decryptionDomains
   * @property {boolean | undefined} debugRequests
   *
   * @typedef SdkOptions
   * @property {import('./config').SupportedCurve | undefined} curve
   * @property {boolean | undefined} retry
   * @property {boolean | undefined} enableOutboundRelay
   *
   * @param {string} appId
   * @param {string} apiKey
   * @param {SdkOptions & OutboundRelayOptions} options
   */
>>>>>>> d9264cb (fix: update NodeSDK to have jsdoc comments for top-level client functions)
...
=======
   ...
   * @property {string | undefined} pcr8
   *
   * @param {{ [key: string]: PCRs }} cagesAttestationData
>>>>>>> d9264cb (fix: update NodeSDK to have jsdoc comments for top-level client functions)
   */
