...
const { CageAttestationError, EvervaultError } = require('./errors');
const tls = require('tls');
const { attestConnection } = require('evervault-attestation-bindings');
...
function attestCageConnection(hostname, cert, cagesAttestationInfo = {}) {
  try {
    ...
    const isConnectionValid = attestConnection(cert.raw, pcrs);
