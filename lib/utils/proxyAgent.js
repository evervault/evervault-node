...
class HttpsProxyAgent extends Agent {
  constructor(
    ...
    isCertificateValidCallback,
    isCertificateUnavaliableCallback
  ) {
    let opts;
    ...
    this._isCertificateUnavaliableCallback = isCertificateUnavaliableCallback;
  ...
  async callback(req, opts) {
    ...
    if (
      (this._isCertificateUnavaliableCallback != null &&
        this._isCertificateUnavaliableCallback()) ||
      (this._isCertificateValidCallback != null &&
        !this._isCertificateValidCallback())
    ) {
      if (this._updateCertificateCallback != null) {
