...
const DEFAULT_API_URL = 'http://api.localhost:3000';
const DEFAULT_TUNNEL_HOSTNAME = 'https://relay.evervault.io:443';
const DEFAULT_CA_HOSTNAME = 'https://ca.evervault.io';
const DEFAULT_CAGES_CA_HOSTNAME = 'https://cages-ca.evervault.io';
const DEFAULT_CAGES_HOSTNAME = 'cages.evervault.io';
